function display(withData, i){
	...
	switch (withData.nature) {
		case "github-file":
			...
			.then(function(response) {
				...
				iframe.innerHTML = code.length >= 1500 ? code.substring(0, 1450)+"...<a class='more-github' target='blank' href='"+withData.url+"'>Voir le code sur github</span" : code;
			});
		break;
		...
		case "github-user":
			className = "github";
			text = withData.user+" <span>sur github</span>";
			icon = "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z";
		break;

		case "github-repos":
			className = "github";
			text = withData.user+"/"+withData.repos+" <span>sur github</span>";
		...
		case "youtube-video":
			...
			className = "youtube";
			text = withData.title;
			$("#playlist .links a.child").selector[i].insertAdjacentHTML('afterend', "<div class='quick quick"+i+"'><iframe frameborder='0' height='315' width='560' allowfullscreen src='https://www.youtube-nocookie.com/embed/"+withData.id+"'></iframe><h3>"+(withData.title.length >= 35 ? withData.title.substring(0, 32)+"..." : withData.title)+"</h3><h4>ajouté par <a class='inline' href='"+withData.channelUrl+"' target='blank'>"+withData.author+"</a> le "+day+" "+month+" "+year+"</h4><p>"+(withData.description.length > 300 ? withData.description.substring(0, 250)+"<span class='text-end'>"+withData.description.substring(250, 300)+"...</span> <a href='https://youtube.com/watch/?v="+withData.id+"' target='blank'>Lire plus sur Youtube</a>" : withData.description)+"</p></div>");
		...
		case "codepen-pen":
			...
			$("#playlist .links a.child").selector[i].insertAdjacentHTML('afterend', "<div class='quick quick"+i+"'><iframe frameborder='0' height='330' width='90%' allowfullscreen src='https://codepen.io/"+withData.user+"/embed/"+withData.id+"/?theme-id=light&default-tab=result'></iframe></div>");
		break;
		...
		case "gmaps-place":
			...
			$("#playlist .links a.child").selector[i].insertAdjacentHTML('afterend', "<div class='quick quick"+i+"'><iframe frameborder='0' height='315' width='90%' src='https://www.google.com/maps/embed/v1/place?key=AIzaSyAJSyBgYsGbs7br8JiQw70NYIFbaQClaXc&q="+withData.place+"'></iframe></div>");
		break;
		...
		case "gmaps-location":
			...
			$("#playlist .links a.child").selector[i].insertAdjacentHTML('afterend', "<div class='quick quick"+i+"'><iframe frameborder='0' height='315' width='90%' src='https://www.google.com/maps/embed/v1/view?key=AIzaSyAJSyBgYsGbs7br8JiQw70NYIFbaQClaXc&center="+withData.lat+","+withData.lng+"&zoom="+withData.zoom+"'></iframe></div>");
		break;
	...
	$("#playlist .links a.child path.icon").selector[i].setAttribute("d", icon);
